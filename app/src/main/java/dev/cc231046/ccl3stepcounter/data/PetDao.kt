...
interface PetDao {
    ...
    @Query("UPDATE pet SET lastRevivalStepsAdded = :lastRevivalStepsAdded, lastRevivalStepsDate = :lastRevivalStepsDate WHERE id = 1")
    suspend fun updateLastRevivalSteps(lastRevivalStepsAdded :Int, lastRevivalStepsDate:String )
